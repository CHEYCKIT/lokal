...
contextBridge.exposeInMainWorld('electron', {
  ...
  batchUpdateTracks: (trackIds, operations) => invoke('track:batchUpdate', trackIds, operations),
  ...
  pluginsDisable: (pluginId) => invoke('plugins:disable', pluginId),
  pluginsInstallFromFolder: (sourceFolderPath) => invoke('plugins:installFromFolder', sourceFolderPath),
  pluginsRemove: (pluginId) => invoke('plugins:remove', pluginId),
